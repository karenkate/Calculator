...
var ButtonSetFunctions = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(Button, { klass: "long-text", text: "History", clickHandler: this._showMemoryBank }),
      React.createElement(Button, { klass: "long-text", text: "CLS", clickHandler: this._clear }),
